...
parser.add_argument("--img_path", type=str, default= '/home/pooja/Guided_Rectification_Network/img.png')
parser.add_argument("--flow_path", type=str, default= '/home/pooja/Guided_Rectification_Network/flow.npy')
